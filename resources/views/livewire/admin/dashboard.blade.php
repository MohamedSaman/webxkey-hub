<div>
    <div class="topbar">
        ...
        <div style="display:flex;gap:8px;align-items:center">
            <span style="font-size:11px;color:var(--text-muted)">{{ now()->format('d M Y, H:i') }}</span>
    ...
    <div class="content-area">
        ...
        <div class="stats-row">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value" style="color:{{ ($stats['down'] ?? 0) > 0 ? 'var(--red)' : 'var(--text-muted)' }}">{{ $stats['down'] ?? 0 }}</div>
        ...
        <div class="sites-grid">
                ...
                <div class="site-card">
                    ...
                    <div class="site-meta">
                        <div>
                            ...
                            <div class="meta-val">
                                @if($health) {{ $health->http_status }} · {{ $health->response_ms }}ms
                                @else —
                                @endif
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="meta-val" @if($sslDays && $sslDays < 30) style="color:var(--yellow)" @endif>
                        ...
                        <div>
                            ...
                            <div class="meta-val" style="font-family:var(--font-mono)">{{ $app->branch }}</div>
                        </div>
                    </div>
            ...
            @empty
                <div style="grid-column:1/-1;text-align:center;padding:60px;color:var(--text-muted);font-size:13px;">
                    No applications yet. <a href="{{ route('deploy') }}" style="color:var(--accent)">Deploy your first app →</a>
                </div>
            @endforelse
        </div>
